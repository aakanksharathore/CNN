...
grabSize = 120#int(m.ceil((100/alt)*12))
#Load model
...
#  #Display image
  ...
  cv2.imwrite('/media/aakanksha/f41d5ac2-703c-4b56-a960-cd3a54f21cfb/aakanksha/Documents/Backup/Phd/Analysis/blackbuckML/CNN/wasptrainingdata/keypoints'+str(i)+'.png',im_with_keypoints)
#  
  cv2.imwrite('/media/aakanksha/f41d5ac2-703c-4b56-a960-cd3a54f21cfb/aakanksha/Documents/Backup/Phd/Analysis/blackbuckML/CNN/wasptrainingdata/detections'+str(i)+'.png',im_with_detections)
