...
for caribou in caribouYN:
        ...
        if caribou[2]==1: #indent if you uncomment previous if statement
            cv2.imwrite('/media/aakanksha/f41d5ac2-703c-4b56-a960-cd3a54f21cfb/aakanksha/Documents/Backup/Phd/Analysis/blackbuckML/training/yesC/' +movieName[len(movieName)-18:len(movieName)-4] +  '_' + str(fNum) +'_' + str(int(caribou[1])) + '.png',cv2.resize(tmpImg,(40,40)))
        if caribou[2]==0:
            cv2.imwrite('/media/aakanksha/f41d5ac2-703c-4b56-a960-cd3a54f21cfb/aakanksha/Documents/Backup/Phd/Analysis/blackbuckML/training/noC/' + movieName[len(movieName)-18:len(movieName)-4] +  '_' + str(fNum) + '_' + str(int(caribou[1])) + '.png',cv2.resize(tmpImg,(40,40)))
            #break
